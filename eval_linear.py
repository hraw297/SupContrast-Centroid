...
def eval_linear(args):
    ...
    if args.dataset_name in ['cifar10', 'cifar100']:
        ...
        val_transform = pth_transforms.Compose([
            pth_transforms.Resize(args.input_size, interpolation=3),
        ...
        if args.dataset_name == 'cifar10':
            dataset_val = datasets.CIFAR10(args.data_path, transform=val_transform, train=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--lr", default=0.001, type=float, help="""Learning rate at the beginning of
        ...
        We recommend tweaking the LR depending on the checkpoint evaluated.""") # 0.3
    ...
    parser.add_argument("--input_size", type=int, help="Image dimension.")
